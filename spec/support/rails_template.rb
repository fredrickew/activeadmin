...
# Require turbo if necessary
if ENV["BUNDLE_GEMFILE"] == File.expand_path("../../gemfiles/rails_61_turbo/Gemfile", __dir__)
  append_file "app/assets/javascripts/active_admin.js", "//= require turbo\n"
end
